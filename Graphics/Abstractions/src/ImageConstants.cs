...
public static class ImageConstants
{
	...
	/// <remarks>
	/// Images with metadata larger than this threshold will use batched async disposal to avoid blocking operations.
	/// Set to 1MB based on performance testing across various image formats.
	/// </remarks>
	...
	/// <remarks>
	/// Used to determine when to yield control during large metadata cleanup operations.
	/// </remarks>
	...
	/// <remarks>
	/// Used primarily in TIFF and other metadata-heavy formats to determine when to suggest GC collection.
	/// Set to 10MB based on memory pressure testing.
	/// </remarks>
