...
public static class TiffValidator
{
	...
	{
		return Enum.IsDefined(typeof(TiffColorDepth), colorDepth);
	}
	...
	{
		return Enum.IsDefined(typeof(TiffCompression), compression);
	}
	...
	public static bool IsValidPhotometricInterpretation(PhotometricInterpretation photometric, TiffColorDepth colorDepth)
	{
		...
		{
			PhotometricInterpretation.WhiteIsZero or PhotometricInterpretation.BlackIsZero => 
				colorDepth is TiffColorDepth.Bilevel or TiffColorDepth.FourBit or TiffColorDepth.EightBit or TiffColorDepth.SixteenBit,
			PhotometricInterpretation.Rgb => 
				colorDepth is TiffColorDepth.TwentyFourBit or TiffColorDepth.ThirtyTwoBit or TiffColorDepth.FortyEightBit or TiffColorDepth.SixtyFourBit,
			PhotometricInterpretation.Palette => 
				colorDepth is TiffColorDepth.Bilevel or TiffColorDepth.FourBit or TiffColorDepth.EightBit,
			PhotometricInterpretation.Cmyk => 
				colorDepth is TiffColorDepth.ThirtyTwoBit,
